...
def decrypt(chiffre, passphrase, cipher='aes-128-cbc'):
    """invoke the OpenSSL library (though the openssl executable which must be
       present on your system) to encrypt content using a symmetric cipher.
       ...
       # encryption use
       >>> c = "texte avec caractères accentués"
       >>> message = decrypt(c, 'foobar')
    """
    # prépare les arguments à envoyer à openssl
    pass_arg = 'pass:{}'.format(passphrase)
...
if __name__ == '__main__':
    ct = encrypt("deborah5", 'e049b0cd53b8b25413a53020cce3ed73')
    print(ct)

    #ct = "U2FsdGVkX18ZD8BkmnEWrYq1VGZUwNq5sMkggQDWpMRx8R5563ZcZF9aKS0zX9a7\nCCqHw44617su7wt5krWRuA=="
    print(decrypt("U2FsdGVkX1+j0qngXU1x72ibt06eVxZR4uFiRQbKV6jpRE4Gz273pQp6dziWzdcD\n", 'Chiara!2001'))
